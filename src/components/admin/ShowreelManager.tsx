      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          ...
          <form onSubmit={handleUpload} className="space-y-4">
            ...
            {message && (
              <div className={`p-3 rounded text-sm ${message.type === 'success' ? 'bg-green-500/10 border-green-500/50 text-green-400' : 'bg-red-500/10 border-red-500/50 text-red-500'} border`}>
                {message.text}
              </div>
            )}
          </form>
