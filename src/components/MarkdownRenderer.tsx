        ...
        components={{
          code(props: { children?: React.ReactNode; className?: string; [key: string]: unknown }) {
            ...
            return match ? (
              ...
              <code {...rest} className={`${className} bg-gray-800 text-pink-400 px-1.5 py-0.5 rounded text-sm`}>
                {children}
              </code>
            );
          },
          ...
          ul: ({ ...props }) => <ul {...props} className="list-disc list-inside mb-4 space-y-1 text-gray-300" />,
          ol: ({ ...props }) => <ol {...props} className="list-decimal list-inside mb-4 space-y-1 text-gray-300" />,
          h1: ({ ...props }) => <h1 {...props} className="text-2xl font-bold mb-4 mt-8 text-white" />,
          h2: ({ ...props }) => <h2 {...props} className="text-xl font-bold mb-3 mt-6 text-white" />,
          h3: ({ ...props }) => <h3 {...props} className="text-lg font-bold mb-2 mt-4 text-white" />,
          blockquote: ({ ...props }) => (
            <blockquote {...props} className="border-l-4 border-blue-500 pl-4 py-1 my-4 bg-gray-800/50 text-gray-300 italic rounded-r" />
          ),
        } as Components}
      >
        {content}
