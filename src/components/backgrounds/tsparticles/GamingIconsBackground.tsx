...
export const GamingIconsBackground = ({
  id = "gaming-particles",
  className,
}: GamingIconsBackgroundProps) => {
        ...
        shape: {
          ...
          options: {
            ...
            image: [
              ...
              {
                src: "https://cdn.jsdelivr.net/npm/lucide-static@0.344.0/icons/gamepad-2.svg",
                width: 32,
                height: 32,
              },
              {
                src: "https://cdn.jsdelivr.net/npm/lucide-static@0.344.0/icons/ghost.svg",
                width: 32,
                height: 32,
              },
            ],
