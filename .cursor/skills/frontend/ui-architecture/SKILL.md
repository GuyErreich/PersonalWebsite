...
description: Guides UI structure for reuse, responsive variants, and viewport layout. Use when designing, refactoring, or reviewing component architecture and folder boundaries.
