---
name: security
description: Prevents SQL injection, XSS, CSRF, and credential leaks with Supabase-safe patterns. Use when reviewing auth, user input, API routes, file uploads, or sensitive data handling.
...
const supabase = createClient(SUPABASE_URL, 'hardcoded-demo-value');
```
