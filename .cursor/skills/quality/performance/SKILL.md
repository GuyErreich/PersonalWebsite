---
name: performance
description: Prevents memory leaks and optimizes render performance for WebGL, AudioContext, and React effects. Use when adding useEffect cleanup, useFrame loops, event listeners, or profiling components.
