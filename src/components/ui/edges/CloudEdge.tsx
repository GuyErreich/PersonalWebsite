  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse 60% 100% at 50% 60%, rgba(6,182,212,0.10) 0%, transparent 100%)' }}
      />

      {/* Bottom seal: smooth 50% gradient into fillColor so the seam is clean */}
      <div
        className="absolute inset-x-0 bottom-0 pointer-events-none"
        style={{ height: '50%', background: `linear-gradient(to top, ${fillColor} 0%, transparent 100%)` }}
      />
      ...
      >
        <defs>
          ...
          <filter id="cloud-displace" x="-5%" y="-30%" width="110%" height="160%" colorInterpolationFilters="linearRGB">
            <feTurbulence
              ref={turbRef}
              type="turbulence"
          ...
          <filter id="cloud-glow" x="-2%" y="-80%" width="104%" height="260%">
