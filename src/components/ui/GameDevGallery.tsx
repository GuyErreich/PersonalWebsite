  ...
  return (
    <div className="flex flex-col gap-4" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
      {isLoading ? (
        ...
        <>
          {/* Grid — outer layout-animated div smoothly resizes on height change;
                    inner relative+overflow-hidden clips the horizontal slide while
                    keeping the popLayout-absolute exiting element within bounds */}
