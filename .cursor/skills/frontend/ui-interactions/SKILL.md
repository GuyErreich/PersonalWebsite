...
description: Wires Framer Motion micro-interactions and generative sound feedback for tactile UI. Use when adding or editing buttons, menus, modals, or interactive components.
