---
name: code-quality
description: Enforces TypeScript and ESLint standards for lint/build validation. Use when fixing lint errors, type issues, removing any/ts-nocheck, empty catch blocks, or validating code before commit.
