---
name: "code-review"
description: "Use when: reviewing code before committing, performing PR self-review, auditing a file or component for quality, checking for bugs, type issues, memory leaks, security issues, missing interaction patterns, reuse violations, or verifying all project conventions are met before opening a PR."
