---
name: threejs
description: Applies R3F performance, typing, shader, and cleanup rules for 3D backgrounds. Use when creating or reviewing files under src/components/backgrounds/three/.
